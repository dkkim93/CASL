...
class SoundNull : public Sound
{
  ...
  public: 
    ...
    */
    ...
    // dkk
    virtual std::vector<uInt8> copy_sound_data() { 
      static const uInt8 values[] = {0}; 
      std::vector<uInt8> empty_vector(values, values+sizeof(values)/sizeof(values[0])); 
      return empty_vector;
    }

    virtual void clear_sound() { }
